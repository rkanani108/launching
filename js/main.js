...
jQuery(document).ready(function() {	
    ...
    */
	...
	$("#subsubmit").on("click",function(){
		...
		//location.replace("https://www.youtube.com/watch?v=foSpMc0y0is&ab_channel=SwaminarayanBhagwan");
	})
...
var austDay = new Date("October 27, 2021 18:59:00");
	...
	function liftOff() { 
		player.loadVideoById ('foSpMc0y0is');
		player.stopVideo(); 
		$('#countdown').hide();
	}
